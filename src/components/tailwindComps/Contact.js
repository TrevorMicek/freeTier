...
const confirmMessage = ['Thanks for reaching out to Websites By Trevor!', 'We will respond ASAP']
  ...
  return (
    <div className="bg-indigo-50 py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24" style={{gridColumn:"span 7", gridRowStart:"second", gridRowEnd:"third"}}>
      <div className="relative max-w-xl mx-auto" >
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-6 text-gray-500">
            Before we get started, we just need to get some more information from you for the site and for our curiosity.
          </p>
        </div>
        <div className="mt-12">
